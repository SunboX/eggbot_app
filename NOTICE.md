...
Original source: https://github.com/SunboX/eggbot_app

Copyright (C) 2026 André Fiedler.

When redistributing this project, modified versions, binaries, firmware images,
packaged applications, or larger works based on this project, preserve the
following as required by the applicable license:
