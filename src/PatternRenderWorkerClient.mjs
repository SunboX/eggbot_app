...
export class PatternRenderWorkerClient {
     ...
     * @param {{ baseColor?: string, lineWidth?: number, palette?: string[], strokes?: Array<{ colorIndex: number, points: Array<{u:number,v:number}>, closed?: boolean, fillGroupId?: number | null, fillAlpha?: number, fillRule?: 'nonzero' | 'evenodd' }>, importedSvgText?: string, importedSvgHeightRatio?: number }} data
     * @param {number} token
