...
export class AppElements {
    ...
    static query(root) {
        ...
        return {
            ...
            espFlashStatus: query('[data-esp-flash-status]'),
            espFlashProgress: query('[data-esp-flash-progress]'),
            espFlashProgressTrack: query('[data-esp-flash-progress-track]'),
            espFlashProgressFill: query('[data-esp-flash-progress-fill]'),
            espFlashProgressPercent: query('[data-esp-flash-progress-percent]'),
            espFlashProgressTime: query('[data-esp-flash-progress-time]'),
