...
export class AppElements {
    ...
    static query(root) {
        ...
        return {
            ...
            connectionTransport: query('[data-connection-transport]'),
            machineBaudRateRow: query('[data-machine-baud-rate-row]'),
            ...
            espFlashOpen: query('[data-esp-flash-open]'),
            espFlashDialogBackdrop: query('[data-esp-flash-dialog-backdrop]'),
            espFlashDialog: query('[data-esp-flash-dialog]'),
            espFlashDialogClose: query('[data-esp-flash-dialog-close]'),
            espFlashDialogCloseIcon: query('[data-esp-flash-dialog-close-icon]'),
            espFlashInstall: query('[data-esp-flash-install]'),
            espFlashVersionValue: query('[data-esp-flash-version-value]'),
            espFlashBrowserNote: queryOptional('[data-esp-flash-browser-note]'),
            espFlashBootHint: queryOptional('[data-esp-flash-boot-hint]'),
            espFlashStatus: queryOptional('[data-esp-flash-status]'),
            espFlashProgress: queryOptional('[data-esp-flash-progress]'),
            espFlashProgressTrack: queryOptional('[data-esp-flash-progress-track]'),
            espFlashProgressFill: queryOptional('[data-esp-flash-progress-fill]'),
            espFlashProgressPercent: queryOptional('[data-esp-flash-progress-percent]'),
            espFlashProgressTime: queryOptional('[data-esp-flash-progress-time]'),
            ...
            controlSettingsExport: query('[data-control-settings-export]'),
            controlSettingsImport: query('[data-control-settings-import]'),
            controlSettingsReset: query('[data-control-settings-reset]'),
            resumeStatus: query('[data-resume-status]'),
            resumeStart: query('[data-resume-start]'),
            resumeClear: query('[data-resume-clear]'),
