...
export class AppElements {
    ...
    static query(root) {
        ...
        return {
            ...
            penColorDialogBackdrop: query('[data-pen-color-dialog-backdrop]'),
            penColorDialog: query('[data-pen-color-dialog]'),
            penColorDialogTitle: query('[data-pen-color-dialog-title]'),
            penColorDialogMessage: query('[data-pen-color-dialog-message]'),
            penColorDialogClose: query('[data-pen-color-dialog-close]'),
            penColorDialogCancel: query('[data-pen-color-dialog-cancel]'),
            penColorDialogContinue: query('[data-pen-color-dialog-continue]'),
            ...
            controlManualResult: queryOptional('[data-control-manual-result]'),
